    ...
    >
      ...
      <LegalSection title="2. 서비스가 제공하는 기능">
        <LegalList>
          ...
          <li>이용자가 녹음하거나 업로드한 노래 음성의 음역·음정 분포 등 보컬 특성 분석</li>
      ...
      <LegalSection title="8. 외부 서비스와 처리 중단">
        <p>
          서비스는 Google 계정 인증과 음성 저장·분석·AI 믹싱에 필요한 처리 시스템을 이용합니다. 해당 시스템의 장애, 정책
          변경이나 네트워크 문제로 일부 기능이 지연 또는 중단될 수 있습니다. 운영자는 가능한 범위에서 상태를 안내하고
          재시도·정리 작업을 수행합니다.
        </p>
      </LegalSection>
