# Tasks: top-three-recommendations
...
- **문서 상태**: Approved
- **레포**: copy-singer-web
- **브랜치**: `feat/top-three-recommendations`
- **대기 중 변경 요청**: -
- **구현 승인**: 2026-08-06 사용자 승인 — 자동 카드 합성은 F006으로 분리
...
- [DONE][PRD-FR-011][PRD-NFR-007] T-F005-01 추천 계약, 결정적 ranking과 설명 문구 구현
  - Date: 2026-08-06
  - Acceptance:
    - F004 결과를 adjusted score, original score, shift 절대값, catalogOrder 순으로 정렬해 정확히 3개를 결정적으로 선택한다.
    - 구조화 reason code와 저장 metric만으로 원키·키 이동·음역 부담·낮은 신뢰도 한국어 설명을 생성한다.
  - Checklist:
