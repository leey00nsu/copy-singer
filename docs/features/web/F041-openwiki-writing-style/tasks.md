...
| 로컬 0.9.12 `knowledge sync F041-openwiki-writing-style --component web` | `2026-09-05` | `FAIL — adapter 1.3.0, 9개 생성 후 OPENWIKI_OUTPUT_INVALID: 운영 문서 :186의 repo://prisma/migrations가 Git tree를 참조; 새 성공 receipt 없음` |
